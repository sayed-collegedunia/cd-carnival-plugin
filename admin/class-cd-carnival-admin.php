...
class Cd_Carnival_Admin
{
	...
	public function enqueue_styles()
	{
		...
		wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/cd-carnival-admin.css', array(), $this->version, 'all');
	}
	...
	public function enqueue_scripts()
	{
		...
		wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/cd-carnival-admin.js', array('jquery'), $this->version, false);
	}
	...
	public function add_plugin_admin_menu()
	{
		 ...
		 */
		add_submenu_page('plugins.php', 'CD Carnival Ticket Generation', 'CD Carnival Settings', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page'));
	}
